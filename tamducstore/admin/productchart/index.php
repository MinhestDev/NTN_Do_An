...
<body>
  ...
  <div class="grid-container">
    ...
    <div class="container-main">
      <div class="container">
        <div class="tag-name">
          <h1> <a href="../main/"> <span class="link-1"> Trang chủ-</span> </a> <a href="../product"> <span class="link-1"> Order-</span> </a>
            <span style="color: rgb(250, 35, 189); font-weight:bold"></span>Biểu đồ
          </h1>
          <br>
        </div>
      </div>
