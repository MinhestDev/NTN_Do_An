...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="container-main">
                ...
                <div class="container">
                    <div class="tag-name">
                        <h1> <a href="../main/"> <span class="link-1"> Trang chủ-</span> </a> <a href="./index.php"> <span class="link-1"> Order-</span> </a>
                        <span style="color: rgb(250, 35, 189); font-weight:bold">#</span>Hóa đơn <?= encodeID($id_order)?> </h1>
                        <br>
                    </div>
                </div>
                    ...
                    <main>
                        <div class="table-content">
                            <div class="table-button-detail">
                                <div class="btn-out">
                                    <a> <button> <span class="fa-solid fa-print"></span> In hóa đơn</button> </a>
                                </div>
