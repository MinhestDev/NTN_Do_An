...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="container-main">
            ...
            <div class="container">
                <div class="tag-name">
                    <h1> <a href="../main/"> <span class="link-1"> Trang chủ-</span> </a> <a href="./index.php"> <span class="link-1"> Product-</span> </a>
                        <span style="color: rgb(250, 35, 189); font-weight:bold"></span>Cập nhật</h1>
                        <br>
    ...
    $(document).ready(function() {
        $("#uploadFrom").on('submit', (function(e) {
            ...
            if (name == null || type == null || manufacture == null || date == null || description == null) {
                // var submit = new Boolean(false);
                showErrorToast("Thất bại!1", "Đã có lỗi xảy ra");
                submit += 1;
            }
            if (submit === 0) {
                $.ajax({
                    ...
                    if (data == 1) {
                        ...
                        showErrorToast("Thất bại2", "Đã có lỗi xãy ra vui lòng kiểm tra lại!");
